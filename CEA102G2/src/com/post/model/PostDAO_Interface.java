...
public interface PostDAO_Interface {
	public void insert(PostVO postVo);	//insert a post with 3 pic
...
//  public List<EmpVO> getAll(Map<String, String[]> map);
	public void insert2(PostVO postVO);	//insert a post with 2 pic
	public void insert3(PostVO postVO);	//insert a post with 1 pic
